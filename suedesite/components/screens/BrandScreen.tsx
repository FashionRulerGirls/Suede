  ...
  return (
    <div className="sd-brand-wrap" style={{ maxWidth: 1240, margin: '0 auto', padding: '28px 40px 0' }}>
      ...
      <div className="sd-brandcard-front" style={{ position: 'relative', minHeight: 420, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', visibility: flipped ? 'hidden' : 'visible', transition: 'visibility 0s linear 350ms', backgroundImage: `linear-gradient(rgba(250,249,246,0.4), rgba(250,249,246,0.4)), url(/assets/imagery/suede-card-bg.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* Brand meta — founder / location / founded. Shows only when the brand
            has entered real values via the portal (placeholders were cleared in
        ...
        {(() => {
          ...
          return (
            <div style={{ position: 'relative', zIndex: 3, textAlign: 'center', padding: '0 40px 10px' }}>
      ...
      <div style={{ padding: '44px 0 8px' }}>
        ...
        <div style={{ maxWidth: 520, margin: '30px auto 0', padding: '24px 26px', border: '1px solid var(--border-subtle)', background: 'var(--surface-card)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, textAlign: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5, maxWidth: 380 }}>Provide a customer service rating</span>
          {serviceAvg != null ? (
