    ...
    <div style={{ maxWidth: 583, margin: '0 auto', padding: '64px 24px 0' }}>
      ...
      <div style={{ background: 'var(--white)', border: '1px solid var(--border-subtle)', padding: 48, display: 'flex', flexDirection: 'column', gap: 28 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <button style={{ alignSelf: 'flex-end', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--ink-500)', textDecoration: 'underline', textUnderlineOffset: 3 }}>Forgot Password?</button>
