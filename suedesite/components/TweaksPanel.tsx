...
/* Reusable Tweaks shell + form-control helpers (ported from tweaks-panel.jsx).
   ...
   TweakButton. Owns the host edit-mode protocol; harmless no-ops outside the
   design host (window.parent === window). */
